...
#ifndef _EZCLOUD_TSL_PROTOCOL_H_
#define _EZCLOUD_TSL_PROTOCOL_H_
...
extern "C"
{
    ...
    struct tsl_prop_impl_s
    {
        ...
        ez_char_t *res_type;
        ez_char_t *index;
        ez_int32_t (*func_set)(tsl_prop_impl_t *thiz, const ez_tsl_value_t *value_in);
        ez_int32_t (*func_get)(tsl_prop_impl_t *thiz, ez_tsl_value_t *value_out);
        union
        {
            ez_int32_t value_int;
            ez_double_t value_double;
            ez_char_t *value_string;
        };
    };
    ...
    struct tsl_action_impl_s
    {
        ...
        ez_char_t *res_type;
        ez_char_t *index;
        ez_int32_t (*func_do)(tsl_action_impl_t *thiz, const ez_tsl_value_t *value_in, ez_tsl_value_t *value_out);
    };
...
#endif /* _EZCLOUD_TSL_PROTOCOL_H_ */

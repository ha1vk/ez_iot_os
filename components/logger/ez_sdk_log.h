...
extern "C"
{
     ...
     *start run log
     */
    EZ_OS_API_EXTERN int32_t EZ_OS_API_CALL ez_sdk_log_start(void);
    /**
     * stop  run log 
     */
    EZ_OS_API_EXTERN void EZ_OS_API_CALL ez_sdk_log_stop(void);

    /**
     * set log  level
     */
    EZ_OS_API_EXTERN void EZ_OS_API_CALL ez_sdk_set_log_level(uint8_t level);

    /**
     * filter log  by tag
     */
    EZ_OS_API_EXTERN void EZ_OS_API_CALL ez_sdk_log_filter_tag(const char *tag);

    /**
    * set log text color status
    */

    EZ_OS_API_EXTERN void EZ_OS_API_CALL ez_sdk_set_text_color_enabled(uint8_t enabled);
     ...
     */
    EZ_OS_API_EXTERN void EZ_OS_API_CALL ez_sdk_log_hexdump(const char *tag, uint8_t width, uint8_t *buf, uint16_t size);
    /**
     * print log
     */
    EZ_OS_API_EXTERN void EZ_OS_API_CALL elog_output(uint8_t level, const char *tag, const char *file, const char *func,const long line, const char *format, ...);

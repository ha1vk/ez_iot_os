...
int ota_sample_module_info_report()
{
    ...
    uassert_int_equal(EZ_OTA_ERR_SUCC, ez_iot_ota_modules_report(&res_t, &module_list, 5000));
	return 0;
}
...
void ut_ota_test(void)
{
    ...
    ezos_delay_ms(1000);
    uassert_int_equal(EZ_OTA_ERR_SUCC, ez_iot_ota_progress_report(&res, (ez_int8_t*)CONFIG_EZIOT_UNIT_TEST_DEV_DISPLAY_NAME, OTA_STATE_DOWNLOAD_COMPLETED, OTA_PROGRESS_MAX));
    ezos_delay_ms(1000);
    uassert_int_equal(EZ_OTA_ERR_SUCC, ez_iot_ota_progress_report(&res, (ez_int8_t*)CONFIG_EZIOT_UNIT_TEST_DEV_DISPLAY_NAME, OTA_STATE_BURNING, OTA_PROGRESS_MAX));
    ezos_delay_ms(1000);
    uassert_int_equal(EZ_OTA_ERR_SUCC, ez_iot_ota_progress_report(&res, (ez_int8_t*)CONFIG_EZIOT_UNIT_TEST_DEV_DISPLAY_NAME, OTA_STATE_BURNING_COMPLETED, OTA_PROGRESS_MAX));
    ezos_delay_ms(1000);
    uassert_int_equal(EZ_OTA_ERR_SUCC, ez_iot_ota_progress_report(&res, (ez_int8_t*)CONFIG_EZIOT_UNIT_TEST_DEV_DISPLAY_NAME, OTA_STATE_REBOOTING, OTA_PROGRESS_MAX));
    ezos_delay_ms(1000);
    uassert_int_equal(EZ_OTA_ERR_SUCC, ez_iot_ota_status_succ(NULL, (ez_int8_t *)CONFIG_EZIOT_UNIT_TEST_DEV_DISPLAY_NAME));
    ezos_delay_ms(1000);
    uassert_int_equal(EZ_CORE_ERR_SUCC, ez_iot_core_stop());
    uassert_int_equal(OTA_CODE_NONE, ez_iot_ota_deinit());
    ez_iot_core_deinit();

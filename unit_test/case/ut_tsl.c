...
UTEST_TC_EXPORT(ut_tsl_errcode, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_prop_report_bool, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_prop_report_int, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_prop_report_float, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_prop_report_str, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_prop_report_jobj, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_prop_report_jarr, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_event_report_null, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_event_report_obj, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);

UTEST_TC_EXPORT(ut_tsl_profile_prop_report_bool, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_prop_report_int, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_prop_report_float, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_prop_report_str, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_prop_report_jobj, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_prop_report_jarr, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_event_report_null, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
UTEST_TC_EXPORT(ut_tsl_profile_event_report_obj, global_init, NULL, CONFIG_EZIOT_UNIT_TEST_CASE_TIEMOUT_SECONDS);
...
static int32_t tsl_action2dev(const ez_char_t *sn, const ez_tsl_rsc_t *rsc_info, const ez_tsl_key_t *key_info,
                              const ez_tsl_value_t *value_in, ez_tsl_value_t *value_out)
{
    return 0;
}

static int32_t tsl_property2cloud(const ez_char_t *sn, const ez_tsl_rsc_t *rsc_info, const ez_tsl_key_t *key_info, ez_tsl_value_t *value_out)
{
    return -1;
}

int32_t tsl_property2dev(const ez_char_t *sn, const ez_tsl_rsc_t *rsc_info, const ez_tsl_key_t *key_info, const ez_tsl_value_t *value)
{
    return 1;
}
...
void ut_tsl_errcode()
{
    ...
    ez_tsl_callbacks_t tsl_things_cbs = {tsl_action2dev, tsl_property2cloud, tsl_property2dev};

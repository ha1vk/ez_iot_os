...
ez_mutex_t ezdev_sdk_kernel_platform_thread_mutex_create()
{
	return g_ezdev_sdk_kernel.platform_handle.thread_mutex_create();
}

void  ezdev_sdk_kernel_platform_thread_mutex_destroy(ez_mutex_t ptr_mutex)
{
	g_ezdev_sdk_kernel.platform_handle.thread_mutex_destroy(ptr_mutex);
}

int ezdev_sdk_kernel_platform_thread_mutex_lock(ez_mutex_t ptr_mutex)
{
	return g_ezdev_sdk_kernel.platform_handle.thread_mutex_lock(ptr_mutex);
}

int ezdev_sdk_kernel_platform_thread_mutex_unlock(ez_mutex_t ptr_mutex)
{

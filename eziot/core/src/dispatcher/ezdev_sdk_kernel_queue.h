...
#define QUEUE_INIT(MSGTYPE)                                                \
    ...
    {                                                                      \
        ...
        g_queue_##MSGTYPE.lock = ezos_mutex_create();                      \
...
#define QUEUE_FINI_V3(MSGTYPE)                                                 \
    ...
    {                                                                          \
        queque_element_##MSGTYPE *element = NULL;                              \
        ezos_mutex_lock(g_queue_raw_##MSGTYPE.lock);                           \
        ...
        ezos_mutex_unlock(g_queue_raw_##MSGTYPE.lock);                         \
        ezos_mutex_destroy(g_queue_raw_##MSGTYPE.lock);                        \
        ezos_memset(&g_queue_raw_##MSGTYPE, 0, sizeof(g_queue_raw_##MSGTYPE)); \
    }

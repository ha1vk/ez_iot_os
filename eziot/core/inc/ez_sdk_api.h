 ...
 */
EZOS_API  EZDEV_SDK_INT32 ez_sdk_init(const ez_server_info_t* pserver_info, const ez_init_info_t* pinit, const EZDEV_SDK_UINT32 reg_mode);
 ...
 *	\see		错误码 ： ezdev_sdk_kernel_error
 */
EZOS_API  EZDEV_SDK_INT32 ez_sdk_start();
 ...
 *	\see		错误码 ： ezdev_sdk_kernel_error
 */
EZOS_API  EZDEV_SDK_INT32 ez_sdk_stop();
/** 
 *  \brief		Boot模块反初始化接口
 ...
 *	\see		错误码 ： ezdev_sdk_kernel_error
 */
EZOS_API  EZDEV_SDK_INT32 ez_sdk_deinit();
 ...
 */
EZOS_API ezdev_sdk_kernel_error ezdev_sdk_kernel_extend_load(const ezdev_sdk_kernel_extend* external_extend);
 ...
 *				ezdev_sdk_kernel_extend_full
 */
EZOS_API ezdev_sdk_kernel_error ezdev_sdk_kernel_extend_load_v3(const ezdev_sdk_kernel_extend_v3* extend_info);
 ...
 */
EZOS_API ezdev_sdk_kernel_error ezdev_sdk_kernel_send(ezdev_sdk_kernel_pubmsg* pubmsg);
 ...
 *				ezdev_sdk_kernel_force_cmd_risk
 */
EZOS_API ezdev_sdk_kernel_error ezdev_sdk_kernel_send_v3(ezdev_sdk_kernel_pubmsg_v3* pubmsg_v3);
 ...
 */
EZOS_API const char* ezdev_sdk_kernel_getdevinfo_bykey(const char* key);

...
typedef struct
{
    ...
    int (*net_work_connect)(int socket_fd, const char *server_ip, EZDEV_SDK_INT32 server_port, EZDEV_SDK_INT32 timeout_ms, char szRealIp[ezdev_sdk_ip_max_len]);
    int  (*net_work_read)(int socket_fd, unsigned char *read_buf, EZDEV_SDK_INT32 read_buf_maxsize, EZDEV_SDK_INT32 read_timeout_ms);

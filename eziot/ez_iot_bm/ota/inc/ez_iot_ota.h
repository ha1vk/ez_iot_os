...
extern "C"
{
    ...
    */
     ...
     * @return ez_int32_t 
     */
    typedef ez_int32_t (*get_file_cb)(u ez_int32_t total_len, u ez_int32_t offset, ez_void_t *data, u ez_int32_t len, ez_void_t *user_data);
    /**
     * @brief 升级包下载过程通知回调
     ...
     * @return ez_int32_t 
     */
    typedef ez_void_t (*notify_cb)(ota_cb_result_e result, ez_void_t *user_data);
     ...
     * @return ez_ota_err_e 
     */
    EZOS_API ez_err_t ez_iot_ota_download(ota_download_info_t *input_info, get_file_cb file_cb, notify_cb notify, ez_void_t *user_data);
